...
### Purpose
Common types, enums, and utilities used across all components. Provides TypeTag enum, ErrorType enum, SourceLocation struct, and utility functions for type assertions and error formatting.
